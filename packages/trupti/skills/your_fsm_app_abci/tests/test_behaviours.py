...
from packages.trupti.skills.your_fsm_app_abci.behaviours import (
    HelloWorldBaseBehaviour,
...
class BaseHelloWorldTest(FSMBehaviourBaseCase):
    """Base test case."""

    path_to_skill = Path(__file__).parent.parent

    behaviour: HelloWorldRoundBehaviour
    behaviour_class: Type[HelloWorldBaseBehaviour]
    next_behaviour_class: Type[HelloWorldBaseBehaviour]
...
class TestCollectRandomnessBehaviour(BaseHelloWorldTest):
...
class TestPrintMessageBehaviour(BaseHelloWorldTest):
    """Tests PrintMessageBehaviour"""

    # TODO: set next_behaviour_class
    behaviour_class: Type[BaseBehaviour] = PrintMessageBehaviour
    next_behaviour_class: Type[BaseBehaviour] = ...
...
class TestRegistrationBehaviour(BaseHelloWorldTest):
...
class TestResetAndPauseBehaviour(BaseHelloWorldTest):
...
class TestSelectKeeperBehaviour(BaseHelloWorldTest):
