...
class TestCollectRandomnessRound(BaseHelloWorldRoundTest):
...
class TestPrintMessageRound(BaseHelloWorldRoundTest):
    """Tests for PrintMessageRound."""

    round_class = PrintMessageRound
...
class TestRegistrationRound(BaseHelloWorldRoundTest):
...
class TestResetAndPauseRound(BaseHelloWorldRoundTest):
...
class TestSelectKeeperRound(BaseHelloWorldRoundTest):
