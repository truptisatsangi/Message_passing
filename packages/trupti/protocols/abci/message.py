...
from packages.trupti.protocols.abci.custom_types import CheckTxType as CustomCheckTxType
from packages.trupti.protocols.abci.custom_types import (
    ConsensusParams as CustomConsensusParams,
)
from packages.trupti.protocols.abci.custom_types import Events as CustomEvents
from packages.trupti.protocols.abci.custom_types import Evidences as CustomEvidences
from packages.trupti.protocols.abci.custom_types import Header as CustomHeader
from packages.trupti.protocols.abci.custom_types import (
    LastCommitInfo as CustomLastCommitInfo,
)
from packages.trupti.protocols.abci.custom_types import ProofOps as CustomProofOps
from packages.trupti.protocols.abci.custom_types import Result as CustomResult
from packages.trupti.protocols.abci.custom_types import SnapShots as CustomSnapShots
from packages.trupti.protocols.abci.custom_types import Snapshot as CustomSnapshot
from packages.trupti.protocols.abci.custom_types import Timestamp as CustomTimestamp
from packages.trupti.protocols.abci.custom_types import (
    ValidatorUpdates as CustomValidatorUpdates,
)


_default_logger = logging.getLogger("aea.packages.trupti.protocols.abci.message")
...
class AbciMessage(Message):
    ...
    protocol_id = PublicId.from_str("trupti/abci:0.1.0")
    protocol_specification_id = PublicId.from_str("trupti/abci:0.1.0")
